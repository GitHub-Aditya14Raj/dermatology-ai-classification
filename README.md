...
## 🎯 Project Overview
Advanced deep learning solution for HAM10000 skin lesion classification achieving **94.21% validation accuracy** with a single model. Target: **96%+ with ensemble**.
